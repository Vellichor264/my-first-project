...
QT_MOC_LITERAL(1, 10, 9), // "startGame"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 8), // "quitGame"
QT_MOC_LITERAL(4, 30, 14), // "onStartClicked"
QT_MOC_LITERAL(5, 45, 13) // "onQuitClicked"

    },
    "StartMenu\0startGame\0\0quitGame\0"
    "onStartClicked\0onQuitClicked"
};
...
void StartMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartMenu::startGame)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (StartMenu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartMenu::quitGame)) {
                *result = 1;
                return;
            }
        }
